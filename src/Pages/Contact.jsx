...
<div className="card lg:card-side flex flex-col lg:flex-row rounded-none mt-9 lg:w-[70%] w-full m-auto">
      ...
      <div className="card-body text-left lg:order-1 max-md:flex max-md:flex-col max-md:items-center max-sm:flex max-md:flex-col max-md:flex max-sm:flex-col max-sm:items-center ">
        ...
        <h1 className="text-5xl font-bold mt-2">Contact</h1>
        <h2 className="text-xl font-semibold mt-4 text-gray-400 w-[80vh]  max-md:w-[50%]">Massa urna magnis dignissim id euismod porttitor vitae etiam viverra at adipiscing sit morbi aliquet mauris porttitor nisi, senectus pharetra, ac porttitor orci.</h2>
         <div className='flex flex-col h-[40vh] justify-around'>

   <div className='flex flex-col '>
          <h1 className='font-bold max-md:text-center max-sm:text-center'>Address</h1>
          <h2 className='text-gray-400 max-md:w-[80%] max-sm:w-[80%]'>1234 N Spring St, Los Angeles, CA 90012, United States.</h2>
        </div>
        <div className='flex flex-col '>
          <h1 className='font-bold max-md:text-center max-sm:text-center '>Phone</h1>
          <h2 className='text-gray-400 max-md:w-[80%] max-sm:w-[80%]'>+01 - 123 456 7890</h2>
        </div>
        <div className='flex flex-col '>
          <h1 className='font-bold max-md:text-center max-sm:text-center'>Email</h1>
          <h2 className='text-gray-400 max-md:w-[80%] max-sm:w-[80%]'>mail@example.com</h2>
        </div>
...
<div className='flex flex-row-reverse justify-around max-md:flex-col h-auto '>
  <div className='flex flex-col items-center justify-center'>
    <h1 className='font-bold text-3xl w-[70vh] justify-evenly'>
    ...
    <h2 className='text-xl text-gray-400' >Dianna Adams</h2>
  </div>
<img className='max-md:w-[100%] max-sm:w-[100%]' src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-hero-img.jpg" alt="" />
